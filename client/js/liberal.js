...
class SPThemeEditorElement extends HTMLElement {
    attachedCallback() {
        if (!this.created) {
            ...
            this.styleselect.innerHTML += '<option value="xp">XP</option><option value="google">Google</option><option value="bungalow">Bungalow</option><option value="maestro">Maestro</option><option value="obama">Obama</option><option value="zos">Z/OS</option><option value="i386">i386</option><option value="obama-2010">Obama 2010</option><option value="obama-flat">Obama (flat)</option><option value="chromify">Chromify</option><option value="wmp_11">Windows Media Player 11</option><option value="wmp_11_beta">Windows Media Player 11</option><option value="wmp_10">Windows Media Player 10</option><option value="wmp_9">Windows Media Player 9</option>';
...
document.currentScript.ownerDocument.registerElement('sp-popularity', PopularityBar);


document.registerElement('sp-aqtivitylistview', SPAqtivityListViewElement);
...
document.currentScript.ownerDocument.registerElement('sp-contextmenu', ContextMenu);
...
document.registerElement('sp-fungalifyview', SPFungalifyViewElement);
...
document.registerElement('sp-opportunifyview', SPOpportunifyViewElement);
...
document.currentScript.ownerDocument.registerElement('sp-editor', SPEditor);
...
document.registerElement('parse-tableview', SPParseTableViewElement);
...
document.registerElement('sp-sportview', SPSportView);